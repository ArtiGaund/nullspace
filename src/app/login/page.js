...
export default function Login(){
    return(
        <div className="flex items-center justify-center bg-gray-950 min-h-screen overflow-hidden overflow-y-hidden">
            ...
            />
            <div className="relative w-[23rem] h-[28rem] bg-gray-900 rounded-2xl p-6 z-20">
                <div className="flex flex-col items-center gap-y-4">
                    ...
                    <div className="flex flex-col items-center justify-center gap-y-2">
                        ...
                        <div className="flex-1">
                            <span className="text-xs text-gray-500">Don&apos;t have an account ? &nbsp;  
                                <a href="/register" className="text-white">Signup</a>
                             </span>
                        </div>
                    ...
                    <div className="flex flex-col items-center justify-center gap-y-2">
                        ...
                        <div className="flex-1 w-[20rem]">
                            {/* Submit button */}
                            <button
                            className="group/btn relative block h-10 w-full rounded-md bg-gradient-to-br from-blue-800 via-blue-900 to-black font-medium text-white shadow-[0px_1px_0px_0px_#ffffff40_inset,0px_-1px_0px_0px_#ffffff40_inset] dark:bg-zinc-800 dark:from-zinc-900 dark:to-zinc-900 dark:shadow-[0px_1px_0px_0px_#27272a_inset,0px_-1px_0px_0px_#27272a_inset]"
                            type="submit"
                            >
                            Login &rarr;
                            </button>
                            <div className="relative text-xs text-gray-500 left-[14rem] top-[3px]">
